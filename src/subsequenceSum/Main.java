...
public class Main {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    maxSum = customMaxSum(true);
                    time = chronometer.stop();
                    System.out.println("[Divide to Conquer] Max sum found = " + maxSum + "\t time = " + time + " nanoseconds"+ "\t" + MaxSum.getBestSubsequence());;
                    break;
                case 3:
     ...
     *
     * @param bf if true, calls brute force method, else, call divider to conquer method
     * @param print if true, the subsequence is saved
     * @return the result of the selected method
     */
    public static int customLength(boolean bf, boolean print) {
       int[] arr = getArr();

        chronometer.start();
        return bf ? MaxSum.bruteForce(arr, print) : MaxSum.divideToConquer(arr, print);
    }
    ...
    public static void menu() {
        System.out.print("\n1 - Max subsequence sum with custom value (Brute Force)\n2 - Max subsequence sum with custom value (Divide to conquer)" +
                ...
                "6 - Random array with custom length with both methods and subsequence print\n\n0 - END\n\nSelect your option: ");
    }
}
